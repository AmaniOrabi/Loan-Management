...
const loan_entity_1 = require("./models/loan.entity");
...
], AppController.prototype, "getLoans", null);
__decorate([
    (0, common_1.Get)('/:id'),
...
], AppController.prototype, "getLoanById", null);
__decorate([
    (0, common_1.Post)('add'),
    ...
    __metadata("design:returntype", void 0)
], AppController.prototype, "addLoan", null);
__decorate([
